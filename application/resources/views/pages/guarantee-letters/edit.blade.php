    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <h3 class="page-title">{{ cleanLang(__('lang.edit_guarantee_letter')) }}</h3>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ cleanLang(__('lang.edit_guarantee_letter')) }}</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="page-content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form id="guarantee-letter-edit-form" method="POST" action="{{ _url('/guarantee-letters/' . $guarantee->guarantee_id) }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="guarantee_number" 
                                               value="{{ old('guarantee_number', $guarantee->guarantee_number) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="guarantee_type" required>
                                            ...
                                            <option value="شرکت در مناقصه" {{ old('guarantee_type', $guarantee->guarantee_type) == 'شرکت در مناقصه' ? 'selected' : '' }}>
                                                {{ cleanLang(__('lang.bid_bond')) }}
                                            </option>
                                            <option value="حسن انجام کار" {{ old('guarantee_type', $guarantee->guarantee_type) == 'حسن انجام کار' ? 'selected' : '' }}>
                                                {{ cleanLang(__('lang.performance_bond')) }}
                                            </option>
                                            <option value="پیش پرداخت" {{ old('guarantee_type', $guarantee->guarantee_type) == 'پیش پرداخت' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="industrial_type">
                                            ...
                                            <option value="بلبرینگ" {{ old('industrial_type', $guarantee->industrial_type) == 'بلبرینگ' ? 'selected' : '' }}>
                                                {{ cleanLang(__('lang.bearing')) }}
                                            </option>
                                            <option value="بلزونا" {{ old('industrial_type', $guarantee->industrial_type) == 'بلزونا' ? 'selected' : '' }}>
                                                {{ cleanLang(__('lang.belzona')) }}
                                            </option>
                                            <option value="پایپ" {{ old('industrial_type', $guarantee->industrial_type) == 'پایپ' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="issuing_bank" 
                                               value="{{ old('issuing_bank', $guarantee->issuing_bank) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="beneficiary" 
                                               value="{{ old('beneficiary', $guarantee->beneficiary) }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="amount" 
                                               value="{{ old('amount', $guarantee->amount) }}" step="0.01" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="currency">
                                            <option value="IRR" {{ old('currency', $guarantee->currency) == 'IRR' ? 'selected' : '' }}>IRR</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="issue_date" 
                                               value="{{ old('issue_date', $guarantee->issue_date) }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="expiry_date" 
                                               value="{{ old('expiry_date', $guarantee->expiry_date) }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="claim_date" 
                                               value="{{ old('claim_date', $guarantee->claim_date) }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="return_date" 
                                               value="{{ old('return_date', $guarantee->return_date) }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="guarantee_status">
                                            <option value="active" {{ old('guarantee_status', $guarantee->guarantee_status) == 'active' ? 'selected' : '' }}>
                                                {{ cleanLang(__('lang.active')) }}
                                            </option>
                                            <option value="expired" {{ old('guarantee_status', $guarantee->guarantee_status) == 'expired' ? 'selected' : '' }}>
                                                {{ cleanLang(__('lang.expired')) }}
                                            </option>
                                            <option value="claimed" {{ old('guarantee_status', $guarantee->guarantee_status) == 'claimed' ? 'selected' : '' }}>
                                                {{ cleanLang(__('lang.claimed')) }}
                                            </option>
                                            <option value="returned" {{ old('guarantee_status', $guarantee->guarantee_status) == 'returned' ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" rows="4">{{ old('description', $guarantee->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2-multiple" name="assigned_user_ids[]" multiple>
                                            @php
                                                $assignedUserIds = $guarantee->assignedUser->pluck('id')->toArray();
                                            @endphp
                                            @if(@count($users ?? []))
                                                @foreach($users as $user)
                                                <option value="{{ $user->id }}" {{ in_array($user->id, old('assigned_user_ids', $assignedUserIds)) ? 'selected' : '' }}>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="ti-save"></i> {{ cleanLang(__('lang.update_guarantee_letter')) }}
                                        </button>
