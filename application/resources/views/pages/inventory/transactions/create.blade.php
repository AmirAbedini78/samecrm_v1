    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <h3 class="page-title">ایجاد تراکنش</h3>
                <ul class="breadcrumb">
    ...
    <div class="page-content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form id="transaction-create-form" method="POST" action="{{ route('inventory.transactions.store') }}">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="transaction_type" required>
                                            <option value="input" {{ old('transaction_type') == 'input' ? 'selected' : '' }}>ورود</option>
                                            <option value="output" {{ old('transaction_type') == 'output' ? 'selected' : '' }}>خروج</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="unit_price" 
                                               value="{{ old('unit_price') }}" step="0.01" min="0" id="unit_price">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="amount" 
                                               value="{{ old('amount') }}" step="0.01" min="0" id="amount" readonly>
                                        <small class="form-text text-muted">به صورت خودکار از مقدار × فی محاسبه می‌شود</small>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="base_document_number" 
                                               value="{{ old('base_document_number') }}">
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    // Form submission
    $('#transaction-create-form').on('submit', function(e) {
        e.preventDefault();
