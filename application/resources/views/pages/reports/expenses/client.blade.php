    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <h3 class="page-title">{{ cleanLang(__('lang.expenses_by_client')) }}</h3>
                <ul class="breadcrumb">
    ...
    <div class="page-content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">{{ cleanLang(__('lang.expenses_by_client_report')) }}</h5>
                        <p class="text-muted">{{ cleanLang(__('lang.expenses_by_client_description')) }}</p>
