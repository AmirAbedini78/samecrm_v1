...
class SalesAggregatesResponse implements Responsable {
    ...
    /**
     * render the view for sales aggregates report
     *
    ...
    public function toResponse($request) {
        ...
        if (request('action') == 'load' || request('action') == 'sort') {
            ...
            if (request('action') == 'load') {
                $html = view('pages/reports/sales/aggregates-table', compact('report'))->render();
                $jsondata['dom_html'][] = [
            ...
            if (request('action') == 'sort') {
                $html = view('pages/reports/sales/aggregates-ajax', compact('report'))->render();
                $jsondata['dom_html'][] = [
            ...
            $html = view('pages/reports/sales/aggregates-wrapper', compact('report'))->render();
            $jsondata['dom_html'][] = [
