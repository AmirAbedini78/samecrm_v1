...
<script src="public/js/rtl.js?v=<?php echo e(config('system.versioning')); ?>"></script>
<?php endif; ?>

<!--[modules] js includes-->
<?php echo config('js.modules'); ?><?php /**PATH C:\laragon\www\samecrm_v1\application\resources\views/layout/footerjs.blade.php ENDPATH**/ ?>